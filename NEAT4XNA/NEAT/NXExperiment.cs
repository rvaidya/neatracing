...
{
    public class NXExperiment : IExperiment
    {
        ...
        {
            populationEvaluator = new SingleFilePopulationEvaluator(new NXNetworkEvaluator(), activationFn);
        }
