...
{
	/// <summary>
	/// Summary description for NEATRacingExperimentView.
	/// </summary>
	public class NEATRacingExperimentView : AbstractExperimentView //System.Windows.Forms.Form
	{
		...
		public NEATRacingExperimentView()
		{
			//
